(function() {
    ...
    // Define the issuetracker application, currently doing nothing.
    var app = angular.module('issuetracker', ['hbpCommon']);
...
angular.bootstrap().invoke(function($http, $log) {
    $http.get('/config.json').then(function(res) {
        ...
        angular.element(document).ready(function() {
            angular.bootstrap(document, ['issuetracker']);
        });
    }, function() {
        $log.error('Cannot boot issuetracker application');
    });
});